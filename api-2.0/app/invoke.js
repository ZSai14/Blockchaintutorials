...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, username, org_name) => {
    try {
        ...
        logger.debug("Getting identity from wallet")
        let identity = await wallet.get(username);
        logger.debug("Got identity from wallet")
        ...
        logger.debug("init connectOptions")
        ...
        // }
            ...
            return `Invocation require either createUser as function but got ${fcn}`
        }
        logger.debug("called and response recieved createUser")
